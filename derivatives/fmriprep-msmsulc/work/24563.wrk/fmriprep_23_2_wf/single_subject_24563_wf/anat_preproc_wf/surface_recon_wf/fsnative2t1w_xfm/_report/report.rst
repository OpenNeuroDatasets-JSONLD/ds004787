Node: single_subject_24563_wf (anat_preproc_wf (surface_recon_wf (fsnative2t1w_xfm (freesurfer)
===============================================================================================


 Hierarchy : fmriprep_23_2_wf.single_subject_24563_wf.anat_preproc_wf.surface_recon_wf.fsnative2t1w_xfm
...
* source_file : /lscratch/8536404/24563.out/sourcedata/freesurfer/sub-24563/mri/T1.mgz
* subjects_dir : /opt/freesurfer/subjects
* subsample_thresh : <undefined>
* target_file : /lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/anat_template_wf/anat_merge/sub-24563_ses-1_rec-orig_run-1_T1w_noise_corrected_template.nii.gz
...
* half_targ_xfm : <undefined>
* half_weights : <undefined>
* out_reg_file : /lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/surface_recon_wf/fsnative2t1w_xfm/T1_robustreg.lta
* registered_file : <undefined>
* weights_file : <undefined>
...
* cmdline : mri_robust_register --satit --iscale --lta /lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/surface_recon_wf/fsnative2t1w_xfm/T1_robustreg.lta --mov /lscratch/8536404/24563.out/sourcedata/freesurfer/sub-24563/mri/T1.mgz --dst /lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/anat_template_wf/anat_merge/sub-24563_ses-1_rec-orig_run-1_T1w_noise_corrected_template.nii.gz
* duration : 92.187795
* hostname : cn4271
* prev_wd : /vf/users/EDB/TMSpilot/code
* working_dir : /lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/surface_recon_wf/fsnative2t1w_xfm
...
--lta: Output transform as /lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/surface_recon_wf/fsnative2t1w_xfm/T1_robustreg.lta . 
--mov: Using /lscratch/8536404/24563.out/sourcedata/freesurfer/sub-24563/mri/T1.mgz as movable/source volume.
--dst: Using /lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/anat_template_wf/anat_merge/sub-24563_ses-1_rec-orig_run-1_T1w_noise_corrected_template.nii.gz as target volume.

reading source '/lscratch/8536404/24563.out/sourcedata/freesurfer/sub-24563/mri/T1.mgz'...
reading target '/lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/anat_template_wf/anat_merge/sub-24563_ses-1_rec-orig_run-1_T1w_noise_corrected_template.nii.gz'...
...
Registration::setSourceAndTarget(MRI s, MRI t, keeptype = TRUE )
 ...
 Determinant after swap : 0.999989
   Mov: (0.799995, 0.799995, 0.799995)mm  and dim (320, 320, 320)
   Dst: (0.799995, 0.8, 0.8)mm  and dim (250, 320, 320)
   Asserting both images: 0.799995mm isotropic 
    - reslicing Mov ...
       -- changing data type from 0 to 3 (noscale = 0)...
       -- Original : (0.799995, 0.799995, 0.799995)mm and (320, 320, 320) voxels.
       -- Resampled: (0.799995, 0.799995, 0.799995)mm and (320, 321, 321) voxels.
       -- Reslicing using cubic bspline 
MRItoBSpline degree 3
    - reslicing Dst ...
       -- Original : (0.799995, 0.8, 0.8)mm and (250, 320, 320) voxels.
       -- Resampled: (0.799995, 0.799995, 0.799995)mm and (320, 321, 321) voxels.
       -- Reslicing using cubic bspline 
MRItoBSpline degree 3
    - WARNING: trg mri outside_val = 0  but suspected background: 4790.39
 ...
 Registration::findSaturation 
   ...
   - running loop to estimate saturation parameter:
     -- Iteration: 1  trying sat: 16
         min sat: 0 ( -1 ), max sat: 16 ( 0.033222 ), sat diff: 16, (wlimit=0.16)
     -- Iteration: 2  trying sat: 8
         min sat: 8 ( 0.752617 ), max sat: 16 ( 0.033222 ), sat diff: 8, (wlimit=0.16)
     -- Iteration: 3  trying sat: 12
         min sat: 8 ( 0.752617 ), max sat: 12 ( 0.0755071 ), sat diff: 4, (wlimit=0.16)
     -- Iteration: 4  trying sat: 10
         min sat: 10 ( 0.467575 ), max sat: 12 ( 0.0755071 ), sat diff: 2, (wlimit=0.16)
     -- Iteration: 5  trying sat: 11
         min sat: 10 ( 0.467575 ), max sat: 11 ( 0.125156 ), sat diff: 1, (wlimit=0.16)
     -- Iteration: 6  trying sat: 10.5
   - final SAT: 11 ( it: 6 , weight check 0.125156 <= 0.16 )
 ...
 Registration::computeMultiresRegistration 
   ...
   - initial transform:
Ti = [ ...
 1.0000000000000                0                0  1.6164773483325 
               0  1.0000000000000                0 -2.2831530423082 
               0                0  1.0000000000000 -3.2792827647751 
               0                0                0  1.0000000000000  ]

   - initial iscale:  Ii =1

Resolution: 4  S( 20 20 20 )  T( 20 20 20 )
 Iteration(f): 1
     -- intensity log diff: abs(-1.63777) 
     -- diff. to prev. transform: 0.350759
 Iteration(f): 2
     -- intensity log diff: abs(-0.309731) 
     -- diff. to prev. transform: 0.844423
 Iteration(f): 3
     -- intensity log diff: abs(-0.102513) 
     -- diff. to prev. transform: 0.399943
 Iteration(f): 4
     -- intensity log diff: abs(-0.101814) 
     -- diff. to prev. transform: 0.217931
 Iteration(f): 5
     -- intensity log diff: abs(-0.110647) 
     -- diff. to prev. transform: 0.541203 max it: 5 reached!

Resolution: 3  S( 40 40 40 )  T( 40 40 40 )
 Iteration(f): 1
     -- intensity log diff: abs(-0.119686) 
     -- diff. to prev. transform: 0.811949
 Iteration(f): 2
     -- intensity log diff: abs(-0.0384953) 
     -- diff. to prev. transform: 0.123393
 Iteration(f): 3
     -- intensity log diff: abs(-0.0126128) 
     -- diff. to prev. transform: 0.049895
 Iteration(f): 4
     -- intensity log diff: abs(-0.00255807) 
     -- diff. to prev. transform: 0.0163488
 Iteration(f): 5
     -- intensity log diff: abs(-0.000460564)  <= 0.001  :-)
     -- diff. to prev. transform: 0.00462815  <= 0.01   :-)

Resolution: 2  S( 80 80 80 )  T( 80 80 80 )
 Iteration(f): 1
     -- intensity log diff: abs(0.00362822) 
     -- diff. to prev. transform: 0.622095
 Iteration(f): 2
     -- intensity log diff: abs(-5.92586e-05)  <= 0.001  :-)
     -- diff. to prev. transform: 0.068137
 Iteration(f): 3
     -- intensity log diff: abs(-4.45379e-06)  <= 0.001  :-)
     -- diff. to prev. transform: 0.00707715  <= 0.01   :-)

Resolution: 1  S( 160 160 160 )  T( 160 160 160 )
 Iteration(f): 1
     -- intensity log diff: abs(0.00115413) 
     -- diff. to prev. transform: 0.277617
 Iteration(f): 2
     -- intensity log diff: abs(-3.1889e-05)  <= 0.001  :-)
     -- diff. to prev. transform: 0.00489234  <= 0.01   :-)

Resolution: 0  S( 320 321 321 )  T( 320 321 321 )
 Iteration(f): 1
     -- intensity log diff: abs(0.00592834) 
     -- diff. to prev. transform: 0.0803793
 Iteration(f): 2
     -- intensity log diff: abs(-0.000541552)  <= 0.001  :-)
     -- diff. to prev. transform: 0.00870761  <= 0.01   :-)

   - final transform: 
Tf = [ ...
 0.9999999583188 -0.0002392363559  0.0001616428263  1.0166780749922 
 0.0002392753076  0.9999999423337 -0.0002409976783  0.0202530564535 
-0.0001615851616  0.0002410363454  0.9999999578959  0.9918176216665 
               0                0                0  1.0000000000000  ]

   - final iscale:  If = 11.3159

Final Transform:
Adjusting final transform due to initial resampling (voxel or size changes) ...
M = [ ...
-0.9999999583188 -0.0001616428263 -0.0002392363559 285.0681671601654 
-0.0002392739384  0.0002409962993  0.9999942202882  0.0204651294133 
 0.0001615842370 -0.9999942358502  0.0002410349662 319.9394457102139 
               0                0                0  1.0000000000000  ]

 Determinant : -0.999989

Intenstiy Scale Factor: 11.3159

writing output transformation to /lscratch/8536404/24563.wrk/fmriprep_23_2_wf/single_subject_24563_wf/anat_preproc_wf/surface_recon_wf/fsnative2t1w_xfm/T1_robustreg.lta ...
converting VOX to RAS and saving RAS2RAS...
Adjusting Intensity of MOV by 11.3159


Registration took 1 minutes and 32 seconds.
